...
### Exercise 1
Based on the help file, the datasaurus_dozen file has 1846 rows and 3 columns (or variables). The variables included in the data frame are: dataset, x and y.
